<template>
    <div class="component contact-form">
        <div class="wrapper">
            <div id="options">
                <SimpleRadioButton :label="'Say Hi'" :name="'contact-options'" :id="'option-1'" :default="true" />
                <SimpleRadioButton :label="'Get a Quote'" :name="'contact-options'" :id="'option-2'" />
            </div>
            <form action="#" @submit.prevent="Validate()">
                <div id="name-info">
                    <BasicTextInput :label="'Name'" :placeholder="'Name'" />
                </div>
                <div id="email-info">
                    <BasicTextInput :label="'Email'" :placeholder="'Email'" :is-required="true" @validation="" />
                </div>
                <div id="message-info">
                    <BasicTextInput :label="'Message'" :placeholder="'Message'" :is-required="true"
                        :is-text-area="true" />
                </div>
            </form>
            <div id="action">
                <BasicButton :type="2" :text="'Send Message'" />
            </div>
        </div>
        <picture id="icon">
            <svg width="692" height="649" viewBox="0 0 692 649" fill="none" xmlns="https://www.w3.org/2000/svg">
